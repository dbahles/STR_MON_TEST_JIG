...
#define FAULT_RELAY_STABLE_MS 50UL
#define FAULT_RELAY_SETTLE_BEFORE_READ_MS 50UL
#define DUT_DEBOUNCE_MS 200UL
#define TEST_BUTTON_DEBOUNCE_MS 50UL
#define TEST_RESULT_RESET_HOLD_MS 1500UL
#define TEST_RESTART_LOCKOUT_MS 1500UL
#define BUZZER_CONFIRM_MS 75UL
#define BUZZER_RESULT_BEEP_MS 75UL
#define BUZZER_RESULT_GAP_MS 100UL
#define LOOP_DELAY_MS 50UL

#define IDLE_READY_LED_FLASH_MS 1000UL
#define RUNNING_RESULT_LED_FLASH_MS 250UL
